...
flat_right_normal_1 = pd.read_csv('rightFootFlat.csv')
flat_right_normal_2 = pd.read_csv('Amog_flat1.csv')
flat_right_normal_3 = pd.read_csv('Amog_flat2.csv')
flat_right_normal_4 = pd.read_csv('Amog_flat3.csv')
flat_right_normal_5 = pd.read_csv('Amog_flat4.csv')
flat_right_normal_6 = pd.read_csv('Amog_flat5.csv')

flat_right_injured_1 = pd.read_csv('rightFootInjuredFlat.csv')
flat_right_injured_2 = pd.read_csv('rightFootInjuredFlat2.csv')
flat_right_injured_3 = pd.read_csv('rightFootInjuredFlat3.csv')
flat_right_injured_4 = pd.read_csv('rightFootInjuredFlat4.csv')
flat_right_injured_5 = pd.read_csv('rightFootInjuredFlat5.csv')
flat_right_injured_6 = pd.read_csv('rightFootInjuredFlat6.csv')
